...
// solc compiler is required to compile
solc = require("solc");
...
let fileContent = fs.readFileSync("D:/Chai/contracts/web3js/demo.sol").toString();
...
web3.eth.getAccounts().then((accounts)=>{
    ...
    console.log("Defult Account:",defaultAccount);
